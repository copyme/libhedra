...
int main(int argc, char *argv[])
{
  ...
  // first testing case
  igl::readOBJ("/home/kacper/Projects/Directional/tutorial/shared/ellipsoid_ex3.obj", V, TC, N, F, FTC, FN);
  ...
  hedra::polygonal_write_OFF(std::string("ellipsoid_ex3.off"), newV, newD, newF);
