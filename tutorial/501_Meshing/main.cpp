...
int main(int argc, char *argv[])
{
  ...
  // first testing case
  igl::readOBJ("/home/kacper/Projects/Directional/tutorial/shared/Christopher_mesh2.obj", V, TC, N, F, FTC, FN);
  ...
  hedra::polygonal_write_OFF(std::string("Christopher_mesh2.off"), newV, newD, newF);
