...
int main(int argc, char *argv[])
{
  ...
  // first testing case
  igl::readOBJ("/home/kacper/Projects/PHex2/data/single_flap_grid_line_over_tri_vertex.obj", V, TC, N, F, FTC, FN);
  ...
  hedra::polygonal_write_OFF(std::string("single_flap_grid_line_over_tri_vertex.off"), newV, newD, newF);
