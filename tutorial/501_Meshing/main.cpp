...
int main(int argc, char *argv[])
{
  ...
  // first testing case
  igl::readOBJ("/home/kacper/Projects/Directional/tutorial/shared/ellipsoid_ex1.obj", V, TC, N, F, FTC, FN);
  ...
  hedra::polygonal_write_OFF(std::string("ellipsoid_ex1.off"), newV, newD, newF);
