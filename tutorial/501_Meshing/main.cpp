...
int main(int argc, char *argv[])
{
  ...
  // first testing case
  igl::readOBJ("/home/kacper/Projects/Directional/tutorial/shared/schwarzp-param-full-seamless.obj", V, TC, N, F, FTC, FN);
  ...
  hedra::polygonal_write_OFF(std::string("schwarzp-param-full-seamless.off"), newV, newD, newF);
...
//  hedra::polygonal_write_OFF(std::string("/home/kacper/Christopher_mesh2.off"), fineV, fineD, fineF);
